...
export default function SearchedChronicle({chronicle} : DetailedSearchChronicleInfoProps) {
    return(
        <div className="search-container">
            ...
            <div className="search-container-stats-container">
                ...
                <p className="search-container-stat">Episodes: {chronicle.episoodes ?? "N/A"}</p>
            ...
            <div className="search-container-bottom">
                ...
                <button className="search-container-add">Add</button>
            </div>
        </div>
    )
}