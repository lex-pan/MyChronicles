...
namespace MyChroniclesApi.Migrations
{
    ...
    [Migration("20240809172040_removeGenreTagTables")]
    partial class removeGenreTagTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyChroniclesApi.Models.Logs.ChronicleEditsLog", b =>
                {
                    ...
                    b.HasOne("MyChroniclesApi.Models.Logs.ChronicleChanges", "changes")
                        .WithOne("edits")
                        .HasForeignKey("MyChroniclesApi.Models.Logs.ChronicleEditsLog", "changes_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
