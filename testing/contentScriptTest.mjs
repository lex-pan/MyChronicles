...
// uncomment this if you want to readd all of these comments
// (async () => {await addToDecipherTable(listOfMethods)})();

console.log(pageInfo(decipherTabs["wuxiaworld.site"], "https://wuxiaworld.site/novel/archean-eon-art-complete-novel/chapter-761/", "Archean Eon Art - Chapter 761 - WuxiaWorld", "Archean Eon Art", 761, "Novel"));
console.log(pageInfo(decipherTabs["wuxiaworld.site"], "https://wuxiaworld.site/novel/the-great-genetic-era-wuxia-dao-novel/chapter-1663/", "The Great Genetic Era - Chapter 1663 - Chapter 1663: The True Value of the Blue Star Force (1) - WuxiaWorld" , "The Great Genetic Era", 1663, "Novel"));
console.log(pageInfo(decipherTabs["wuxiaworld.site"], "https://wuxiaworld.site/novel/global-lord-100-drop-rate/chapter-1201/", "Global Lord: 100% Drop Rate - Chapter 1201 - 1201 Mythical-Tier—The Only Lord Talent—King Of Undying! - WuxiaWorld", "Global Lord: 100% Drop Rate", 1201, "Novel"));
console.log(pageInfo(decipherTabs["wuxiaworld.site"], "https://wuxiaworld.site/novel/warning-providence-the-beauty-is-driven-to-villainy-wuxia-dao-novel/chapter-756/", "Warning : Providence the Beauty is Driven to Villainy - Chapter 756 - Chapter 756: Sir can read people’s minds (15)_1 - WuxiaWorld", "Warning : Providence the Beauty is Driven to Villainy", 756, "Novel"));
console.log(pageInfo(decipherTabs["wuxiaworld.site"], "https://wuxiaworld.site/novel/reincarnation-of-the-strongest-sword-god-spp/chapter-3789/", "Reincarnation Of The Strongest Sword God - Chapter 3789 - Chapter 863 - Flame Dragon God's Treasury - WuxiaWorld" , "Reincarnation Of The Strongest Sword God", 3789, "Novel"));


console.log(pageInfo(decipherTabs["chapmanganato.to"], "https://chapmanganato.to/manga-td996460/chapter-5.3", "Grimace Vol.1 Chapter 5.3: Cat Scratch - Manganelo" , "Grimace", 5.3, "Graphic Novel"));
...
console.log(pageInfo(decipherTabs["asuracomic.net"], "https://asuracomic.net/8612194254-the-heavenly-demon-cant-live-a-normal-life-chapter-114/", "The Heavenly Demon Cant Live a Normal Life Chapter 114 – Ecorche’s Sword – Asura Scans"  , "The Heavenly Demon Cant Live a Normal Life", 114, "Graphic Novel"));
console.log(pageInfo(decipherTabs["asuracomic.net"], "https://asuracomic.net/8612194254-solo-leveling-chapter-198-side-story-19/", "Solo Leveling Chapter 198 – Side Story 19 – Asura Scans"  , "Solo Leveling", 198, "Graphic Novel"));
